          ...
          items: [
            { label: 'Overview', slug: 'lesson-plans' },
            {
              ...
              items: [
                ...
                { label: 'Ecosystems', slug: 'lesson-plans/science/ecosystem-web' },
              ],
            },
            {
              label: '📐 Math',
              ...
              items: [
                ...
                { label: 'Expressions & Equations', slug: 'lesson-plans/math/expressions-equations' },
                { label: 'Geometry & Shapes', slug: 'lesson-plans/math/geometry-shapes' },
              ],
            },
            {
              label: '⚙️ Engineering',
